...
export default function DonatePage() {
  return (
    <>
      ...
      {/* ============ Suggested amounts ============ */}
      <section className="section section--cream-2" id="amounts">
      <div className="shell">
      <div className="section-head section-head--center">
      <span className="eyebrow eyebrow--center" data-reveal="">Suggested Amounts</span>
      <h2 data-reveal="" style={{ "--d": "80" } as React.CSSProperties}>Choose an Amount That Feels Right</h2>
      <p data-reveal="" style={{ "--d": "150" } as React.CSSProperties}>
      These figures are suggestions only — a starting point, nothing more. Every amount is
      welcome, and each one goes towards the same everyday needs described above.
      </p>
      </div>

      {/* Every preset carries the SAME note on purpose. Giving each amount its own
      destination would assert a restricted-fund policy the trust has never published,
      and would contradict the paragraph above. Do not vary the note by amount. */}
      <div className="give-grid give-grid--5" data-give="" role="radiogroup" aria-label="Suggested donation amount">
      <button className="give-card" type="button" role="radio" aria-checked="false" data-amount="500" data-reveal="">
      <span className="give-card__mark" aria-hidden="true"></span>
      <span className="give-card__tag">Suggested</span>
      <span className="give-card__amount">₹500</span>
      <span className="give-card__note">Towards food, shelter, clothing, education and moral support</span>
      </button>

      <button className="give-card" type="button" role="radio" aria-checked="false" data-amount="1000" data-reveal="">
      <span className="give-card__mark" aria-hidden="true"></span>
      <span className="give-card__tag">Suggested</span>
      <span className="give-card__amount">₹1,000</span>
      <span className="give-card__note">Towards food, shelter, clothing, education and moral support</span>
      </button>

      <button className="give-card" type="button" role="radio" aria-checked="false" data-amount="2500" data-reveal="">
      <span className="give-card__mark" aria-hidden="true"></span>
      <span className="give-card__tag">Suggested</span>
      <span className="give-card__amount">₹2,500</span>
      <span className="give-card__note">Towards food, shelter, clothing, education and moral support</span>
      </button>

      <button className="give-card" type="button" role="radio" aria-checked="false" data-amount="5000" data-reveal="">
      <span className="give-card__mark" aria-hidden="true"></span>
      <span className="give-card__tag">Suggested</span>
      <span className="give-card__amount">₹5,000</span>
      <span className="give-card__note">Towards food, shelter, clothing, education and moral support</span>
      </button>

      <button className="give-card give-card--custom" type="button" role="radio" aria-checked="false" data-amount="" data-reveal="">
      <span className="give-card__mark" aria-hidden="true"></span>
      <span className="give-card__amount">Custom</span>
      <span className="give-card__note">Give any amount you wish</span>
      </button>
      </div>

      <div className="form-grid" style={{ marginTop: "2.2rem" } as React.CSSProperties}>
      <div className="field" data-reveal="">
      <label htmlFor="giveAmount">Amount you plan to give (₹)</label>
      {/* No name attribute: this input is not inside a <form> and nothing is submitted
      anywhere. It exists so the tier buttons have somewhere to write. */}
      <input id="giveAmount" type="text" inputMode="numeric" data-give-amount="" placeholder="Enter an amount" />
      <p className="muted-note" style={{ marginTop: ".4rem" } as React.CSSProperties}>
      This box is a note to yourself — nothing is charged here.
      </p>
      </div>

      <div className="note-card" data-reveal="">
      <b>How to complete your gift.</b>
      Once you have decided, transfer the amount to the trust's State Bank of India account or
      scan one of the QR codes above. The website does not take payments — your bank or
      payments app does, and the money reaches the trust directly.
      </div>
      </div>
      </div>
      </section>
